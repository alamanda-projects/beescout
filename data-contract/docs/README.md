...
Field ini menggambarkan standar versi dari Data Contract_. _Standard versioning_ yang diterapkan akan mengikuti standar **_semantic versioning_** yang dapat dibaca lebih lanjut pada https://semver.org.
...
| metadata.quality.code.dimension                  | NO       | Prinsip kualitas data [*Completeness, Validity, Uniqueness, Accuracy, Timeliness, Consistency, Security*] — perbendaharaan lengkap aturan & dimensi lihat [quality-rules.md](./quality-rules.md)                                                                                                                                                                                                                                                     |
| metadata.quality.code.impact                     | NO       | Jenis dampak bila aturan kualitas dilanggar [*operational, financial, regulatory, reputational*] — lihat [ADR-0003](../../docs/adr/0003-impact-severity-split.md) (dipisah dari `severity`)                                                                                                                                                                                                                                                          |
| metadata.quality.code.on_failure                 | NO       | Tindakan engine saat rule gagal [*abort, warn, quiet*] — `skip` hanya untuk rule kolom. Absen = fallback dari `severity` (high→abort, selainnya warn). Lihat [ADR-0008](../../docs/adr/0008-quality-on-failure.md) (#151)                                                                                                                                                                                                                             |
...
| model.quality.impact                     | NO       | Jenis dampak bila aturan kualitas dilanggar [*operational, financial, regulatory, reputational*] — [ADR-0003](../../docs/adr/0003-impact-severity-split.md) |
| model.quality.on_failure                 | NO       | Tindakan engine saat rule gagal [*abort, warn, skip, quiet*] — absen = fallback dari `severity`. [ADR-0008](../../docs/adr/0008-quality-on-failure.md) (#151) |
